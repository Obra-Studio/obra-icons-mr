	...
	<div class="bg-black">
		<div class="container padding-medium margin-0-auto">
			...
			<div class="vertical-container-x-large">
				<div class="heading-and-list">
					<h2 class="text-align-center">Base set</h2>
					<ul class="justify-content-center flex gap-medium">
						<li>Forever free</li>
						<li>226 high quality icons</li>
					</ul>
				</div>
			...
			<div class="vertical-container-x-large">
				<div class="heading-and-list">
					<h2 class="text-align-center">Obra Icons Plus</h2>

					<ul class="justify-content-center flex gap-medium">
						<li>Version 1.0.0</li>
						<li>75 high quality stroke and fill icons</li>
						<li class="show-md hide-sm">
							<a href="./">Buy a license</a>
						</li>
					</ul>
				</div>

				<!-- List of icons in Obra Icons Plus, as image -->
				<div class="padding-medium text-align-center">
					<div class="hide-md">
						<img
							srcset="/plus-mobile.png 1x, /plus-mobile@2x.png 2x"
							src="/plus-mobile.png"
							alt="Plus set - Obra Icons"
						/>
					</div>
					<div class="show-md hide-sm">
						<img
							srcset="/plus.png 1x, /plus@2x.png 2x"
							src="/plus.png"
							alt="Plus set - Obra Icons"
						/>
					</div>
...
<div class="container padding-medium margin-0-auto">
	<div class="vertical-container-x-large">
		<div class="columns buy-obra-icons-plus">
			...
			<div class="column">
				<div class="content">
					<h2>Buy Obra Icons Plus</h2>

					<ul>
						<li>
							SVG file with original, non-outlined vectors for
							further customization
						</li>
						<li>
							Extend the original stroke set with filled
							equivalents
						</li>
						<li>Plus, 100+ more stroke-based icons</li>
					</ul>
