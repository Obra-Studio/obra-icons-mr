...
const MouseRightClick = forwardRef<SVGSVGElement, StrokeIconProps>(
	({ size = 24, color = 'currentColor', strokeWidth = 2, ...props }, ref) => {
		return (
			...
			>
				<g className="oi-mouse-right-click">
					<path
						className="oi-vector"
