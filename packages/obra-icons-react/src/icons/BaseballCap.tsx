...
const BaseballCap = forwardRef<SVGSVGElement, StrokeIconProps>(
		...
		return (
			...
			>
				<g className="oi-baseball-cap">
					...
					<path
						className="oi-vector"
						d="M8.2875 11.7131C8.67844 6.32156 12 3 12 3C12 3 15.3216 6.32156 15.7125 11.7131"
						stroke={color}
						strokeWidth={strokeWidth}
						strokeLinecap="round"
						strokeLinejoin="round"
