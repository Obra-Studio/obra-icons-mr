...
>
	<g class="oi-fire">
		...
		<path
			class="oi-vector"
			d="M10.854 12.004C8.95151 13.7335 8.14051 15.334 8.42151 16.8055C8.66301 18.0725 9.62451 18.688 10.3485 18.887C10.91 19.0405 11.882 19.127 12.75 18.3535C13.67 17.534 13.3035 16.3695 11.97 14.9285C11.407 14.321 11.035 13.346 10.854 12.004Z"
			stroke={color}
			stroke-width={strokeWidth}
			stroke-linejoin="round"
		/>
